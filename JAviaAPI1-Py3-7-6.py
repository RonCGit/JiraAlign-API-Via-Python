...
def ParseUsers(response):
    ...
    for eachUsr in data["Results"]:
        ...
        un = eachUsr['UID']
        em = eachUsr['Email']
        #print ("Firstname:" + fn," Lastname:" + ln," UserID:" + un, " Email:" + em)
        WriteCsvFile("Firstname:" + fn," Lastname:" + ln," UserID:" + un, " Email:" + em)
...
# This function creates a csv file with the filename fed to it
def MakeCsvFile(filename):
    global out
    out = csv.writer(open(filename+'.csv','w'), delimiter=',',quoting=csv.QUOTE_MINIMAL)

#This function writes lines to the file created in MakeCsvFile  
def WriteCsvFile(info1,info2,info3,info4):
    out.writerow([info1,info2,info3,info4])
...
if "users" in apiendpoint:
    ...
    if (addUsr == "Y") or (addUsr == "y"):
        ...
        print ("This script is now going to create a comma delimited file clled userlist.csv in the same directory of this script with all of the users listed \n")
